...
#ifdef POP_LOD_BLENDING_ENABLED
uniform float uPopPreviousLod;
uniform float uPopLodBlendingTime;
uniform float uPopLodBlendingPeriod;
#endif
	...
	vec4 worldPosition = vec4(aPosition, 1.0);
		...
		float popProtected = 0.0;
			...
			worldPosition = pop_mix(
				...
				uPopLodBlendingTime,
				uTime,
				uPopLodBlendingPeriod,
				uPopFullPrecisionLod,
				uPopMinBound,
				uPopMaxBound,
				popProtected
			);
		...
		#endif // POP_LOD_BLENDING_ENABLED
